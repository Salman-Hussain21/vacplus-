            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">Register Hospital</h3>
                ...
                <div class="card-body">
                  ...
                  <div class="mb-3">
                  <input type="text"  class="form-control"  placeholder="ABC Hospital" name="name" required>
                  </div>
...
<?php
                if(isset($_POST['btnregister']))
                {
                    ...
                    $city = $_POST['city'];
                    $query = "INSERT INTO tbl_hospital(name,email,password,contact,address,cid) VALUES('$name','$email','$password','$contact','$address','$city')";
                    $result = mysqli_query($connection,$query);
                    if($result)
                    {
                        echo 
                        "<script>
                            alert('Registration Successful, PLease wait for your account to get registered');
