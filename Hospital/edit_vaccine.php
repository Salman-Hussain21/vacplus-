			...
			************* -->
			<div class="main-container">
				...
				<div class="page-header">
					...
					<ol class="breadcrumb">
						<li class="breadcrumb-item active">Add Vaccine Details</li>
					</ol>
...
<center>
						...
						<div class="col-lg-6 col-sm-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Update Vaccine Details</div>
								</div>
								<div class="card-body">
									<div class="row gutters">
										<div class=col-sm-6 col-12">
											<div class="form-group" method="post" enctype="multipart/form-data" autocomplete="off">
												...
												<label for="fullName" style="float: left;">Vaccine Name</label>
												<input type="text" class="form-control" id="fullName" placeholder="ABC " name="name" required="" class=""  value="<?php echo $row['name'];?>">
											</div>
										</div>
                                        ...
                                        <div class="form-group">
                                            <label for="status" style="float: left;" >Vaccine Status</label>
										...
										<div class="col-sm-12">
											<div class="text-right">
												<button class="btn btn-primary" name="btnadd">Add Vaccine</button>
											</div>
										</div>
                                        </form>
									</div>
                    ...
                    if(isset($_POST['btnadd']))
                    {
                        ...
                        $status = $_POST['status'];
                        $query = "UPDATE tbl_vaccine SET name='$name',status='$status' WHERE id=$_GET[id]";
                        $result = mysqli_query($connection,$query);
                        if($result)
                        {
                            echo 
