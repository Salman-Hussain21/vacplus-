			...
			************* -->
			<div class="main-container">
				...
				<div class="page-header">
					...
					<ol class="breadcrumb">
						<li class="breadcrumb-item active">Manage Hospitals</li>
					</ol>
				...
				<div class="content-wrapper">
					...
					<br>
					<a href='add_hospital.php?id=$row[id]' class='btn btn-primary'>Add Hospital</a>
					<br><br>
					...
					<?php
                            ...
                            foreach($result as $row)
                            {
                                ...
                                "<tr>
                                    ...
                                    <td>$row[status]</td>
                                    <td>
                                    <a href='edit_hospital.php?id=$row[id]' class='btn btn-primary'>Edit</a>&nbsp;
                                    <a href='delete_hospital.php?id=$row[id]' class='btn btn-primary'>Delete</a>&nbsp";
                                        if($row['status']=="deactivate")
                                        {
                                            echo "<a href='activate_hospital.php?id=$row[id]' class='btn btn-success'>Activate</a>"; 
                                        }
                                        else
                                        {
                                            echo "<a href='deactivate_hospital.php?id=$row[id]' class='btn btn-danger'>Dectivate</a>"; 
                                        }
                                    "</td>
                                </tr>";
                            }
