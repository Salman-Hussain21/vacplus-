									...
									<div class="row gutters">
										<div class=col-sm-6 col-12">
											<div class="form-group" method="post" enctype="multipart/form-data" autocomplete="off">
												...
												<input type="text" class="form-control" id="fullName" placeholder="ABC Hospital" name="name" required="" class="" value="<?php echo $row['name'];?>">
											</div>
										</div>
										<div class=col-sm-6 col-12">
											<div class="form-group">
												<label for="inputEmail" style="float: left;">Email</label>
												<input type="email" class="form-control" id="inputEmail" placeholder="example: hospital@gmail.com" name="email" required="" value="<?php echo $row['email'];?>">
											</div>
										</div>
                                        <div class=col-sm-6 col-12">
											<div class="form-group">
												<label for="password" style="float: left;">Password</label>
												<input type="Password" class="form-control" id="password" placeholder="Enter Your Password" name="password" required="" value="<?php echo $row['password'];?>">
											</div>
										</div>
										<div class=col-sm-6 col-12">
											<div class="form-group">
												<label for="education" style="float: left;">Contact Number</label>
												<input type="text" class="form-control" id="education" placeholder="+92 123456789" name="phone" required="" value="<?php echo $row['contact'];?>">
											</div>
										</div>
                                        <div class=col-sm-6 col-12">
											<div class="form-group">
										...
										<div class=col-sm-6 col-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="addreSs" rows="1" placeholder="Current Address" name="address" required="" value="<?php echo $row['address'];?>">
											</div>
										</div>
