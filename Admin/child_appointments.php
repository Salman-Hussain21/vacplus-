                            ...
                            foreach($result as $row)
                            {
                                ...
                                "<tr>
									...
									<td>";
                                        ...
                                        {
                                            echo "<a href='book_appointment.php?id=$row[id]' class='btn btn-success'>Approve</a>"; 
                                        }
                                        else
                                        {
                                            echo "<a href='cancel_appointment.php?id=$row[id]' class='btn btn-danger'>Reject</a> &nbsp;"; 
                                        }
                                    "</td>
									...
									{
										echo "<a href='book_appointment.php?id=$row[id]' class='btn btn-success'>Approve</a>"; echo "<br>"; 
									}
								"</td>
                                </tr>";
                            }
